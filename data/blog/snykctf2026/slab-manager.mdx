...
authors: [varik]
date: 2026-03-01
tags: [CTF, Snyk2026, PWN, Heap Exploitation, FSOP]
...
![Snyk CTF 2026 results](/static/images/snykctf2026/snyk-results.png)
...
We got the challenge binary, first step is to reverse it with Ghidra.
After reversing we found 4 interesting functions and `main`.
...
![GDB source view](/static/images/snykctf2026/gdb_src.png)

We can also switch to pwndbg's disassembly view with source code, register state, and stack all visible at once:

![pwndbg source view](/static/images/snykctf2026/pwndbg_src.png)

And with pwndbg we get `heap` and `bins` commands which are essential for heap exploitation:

![pwndbg heap command](/static/images/snykctf2026/pwndbg_heap.png)

![pwndbg bins command](/static/images/snykctf2026/pwndbg_bins.png)
...
![one_gadget output](/static/images/snykctf2026/one_gadget.png)
